...
begin
  ...
  set normalized_transaction_id = public.norwyn_normalize_transaction_id(r.transaction_id),
      ...
      sale_comparable = public.norwyn_normalize_transaction_id(r.transaction_id) is not null
  ...
  select jsonb_build_object(
    ...
    'hotmart_total', (select count(distinct r.normalized_transaction_id) from public.norwyn_hotmart_validation_rows r where r.upload_id = p_upload_id and r.normalized_transaction_id is not null),
